		...
		<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h3>Unlock Your Career Potential: Your Gateway to Graduates' Dream Jobs</h3>
									<p>Our website is dedicated to helping graduates find their dream job and kick-start their career journey. We understand that finding a job can be a daunting task, which is why we are committed to providing a platform that connects graduates with exciting opportunities. Our team is made up of experienced professionals who are passionate about helping graduates succeed. We work with top companies in various industries to provide our users with a wide range of job openings, from entry-level positions to more advanced roles. </p>
                                    	<p>Our goal is to make the job search process as smooth and stress-free as possible. We also provide resources such as resume and cover letter templates, interview tips, and career advice to help our users stand out from the competition. </p>
								</div>  
							</div>
						</div>
	<div class="row">
								<div class="col-md-6">
									<p>Join us today and let's work together to help you achieve your career goals!</p>
